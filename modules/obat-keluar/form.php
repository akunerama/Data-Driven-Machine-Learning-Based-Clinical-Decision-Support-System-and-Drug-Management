  <script type="text/javascript">
    ...
    //     } else {
    //       el.value = "";
    //       if (el.classList.contains("jumlah_Keluar")) {
    //         el.onkeyup = function() {
    //           cek_jumlah_Keluar(this);
    //           hitung_total_stok(this);
    //         };
    //       }
    //     }
    //   });
            ...
            <form role="form" class="form-horizontal" action="modules/obat-Keluar/proses.php?act=insert" method="POST" name="formObatKeluar">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="tanggal_Keluar" value="<?= date("d-m-Y"); ?>" readonly required>
                  </div>
                </div>
